...
/*
yxm created at 2019/4/25 10:02:16
*/
namespace Agro.Module.DataExchange.LandDotCoil
{
	public class DotCoilBuilder
	{
		...
		public DotColBuilderResult Build()
		{
		...
		private void OutputJzx(JzdRing r, Action<JzxItem> callback)
		{
		...
		private JzxItem MakeJzx(List<JzdItem> lst, List<Coordinate> lstC)
		{
			lstC.Clear();
			var jzx = new JzxItem()
			{
			...
			jzx.Shape = GeometryUtil.MakeLineString(lstC.ToArray());
			lst.Clear();
