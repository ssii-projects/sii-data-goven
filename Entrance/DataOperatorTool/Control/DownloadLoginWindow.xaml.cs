...
namespace DataOperatorTool
{
	...
	/// yxm 2018-1-23
	/// </summary>
	public partial class DownloadLoginWindow : Window
	{
		...
		public Func<string,string,string?> Login { get; set; }
		//private IFeatureWorkspace _db;

		//private SEC_ID_USER _user;
		//private bool _fShowInnerConnectionDialog;
		public DownloadLoginWindow()//ConnectionStringTypeMetadata cs = null)
		{
		...
		private void BtnOK_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				var err=Login(txtUsername.Text.Trim(), txtPwd.Password);
				if (err!=null)
				{
