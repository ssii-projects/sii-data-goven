...
namespace JzdxBuild
{
    ...
    public class InitLandDotCoil
    {
        ...
        class JzdTable : TableBase
        {
            ...
            private IPoint _tmpPoint = GeometryUtil.MakePoint(0, 0);// new NetTopologySuite.Geometries.Point(0,0);
        ...
        class JzxTable : TableBase
        {
            ...
            //    //coords[0] = CglUtil.deflection_distance(lst[1].shape, ptFrom, -90, distance);
            //    for (int i = 1; i < lst.Count; ++i)
            //    {
            //        var ptTo = lst[i].shape;
            //        var ls = CglUtil.OffsetLeft(ptFrom, ptTo, distance);
            //        lines.Add(ls);
            //        //var c1 =CglUtil.deflection_distance(ptFrom, ptTo, 90, distance);
            //        //var c2 = CglUtil.deflection_distance(ptTo, ptFrom, -90, distance);
            //        //coords.Add(c1);
            //        //coords.Add(c2);
            //        //coords[i] = c1;
            //        ptFrom = ptTo;
            ...
            //    //return GeometryUtil.MakeLine(coords.ToArray());
            //}
