...
class ViewHolder(private val mContext: Context, val convertView: View, parent: ViewGroup, position: Int) {
    ...
    fun setVisible(viewId: Int, visibility: Int): ViewHolder {
        val view = getView<View>(viewId)
        view.visibility =visibility// if (visible) View.VISIBLE else View.GONE
        return this
    }
