...
namespace Agro.Office
{
    ...
    public abstract class ExcelBase : IDisposable
    {
        ...
        private Dictionary<string, int> columnDictionary;//列索引值
        ...
        public void Print()
        {
            ...
            List<string> printers = ToolPrinter.GetLocalPrinters();
        ...
        public bool Open(string fileName)
        {
            ...
            try
            {
                ...
                if (workbook != null)
                {
                    ...
                    {
                        workbook.Worksheets[0].Name = "农业地图";
                    }
        ...
        /// </summary>
        /// <returns></returns>
        public void SetWorkSheetRangeColor(string start, string end, Color color)
        {
            int startRow = InitalizeIndex(start);
            int startColumn = InitalizeLetter(start);
            int endRow = InitalizeIndex(end);
            ...
            style.Pattern = color == Color.White ? BackgroundType.None : BackgroundType.Solid;
            if (startRow == endRow && startColumn == endColumn)
            {
                cell.SetStyle(style);
                return;
        ...
        public bool IsAlikeStyle(string start, string end, Color color)
        {
            int startRow = InitalizeIndex(start);
            int startColumn = InitalizeLetter(start);
            int endRow = InitalizeIndex(end);
            ...
            Color foreColor = style.ForegroundColor;
            if (foreColor.Name == "0" && color.B == 0 && color.R == 0 && color.G == 0)
            {
                return true;
            }
            if (foreColor.Name == "0" && color.B == 255 && color.R == 255 && color.G == 255)
            {
                return true;
            }
            return foreColor.B == color.B && foreColor.G == color.G && foreColor.R == color.R;
        }
        ...
        public int InitalizeLetter(string value)
        {
            ...
            if (columnDictionary.ContainsKey(letter))
            {
                columnDictionary.TryGetValue(letter, out index);
            }
            return index;
        }
        ...
        private void InitalizeColumn()
        {
            ...
            columnDictionary.Add("A", 0);
            columnDictionary.Add("B", 1);
            columnDictionary.Add("C", 2);
            columnDictionary.Add("D", 3);
            columnDictionary.Add("E", 4);
            columnDictionary.Add("F", 5);
            columnDictionary.Add("G", 6);
            columnDictionary.Add("H", 7);
            columnDictionary.Add("I", 8);
            columnDictionary.Add("J", 9);
            columnDictionary.Add("K", 10);
            columnDictionary.Add("L", 11);
            columnDictionary.Add("M", 12);
            columnDictionary.Add("N", 13);
            columnDictionary.Add("O", 14);
            columnDictionary.Add("P", 15);
            columnDictionary.Add("Q", 16);
            columnDictionary.Add("R", 17);
            columnDictionary.Add("S", 18);
            columnDictionary.Add("T", 19);
            columnDictionary.Add("U", 20);
            columnDictionary.Add("V", 21);
            columnDictionary.Add("W", 22);
            columnDictionary.Add("X", 23);
            columnDictionary.Add("Y", 24);
            columnDictionary.Add("Z", 25);
            columnDictionary.Add("AA", 26);
            columnDictionary.Add("AB", 27);
            columnDictionary.Add("AC", 28);
            columnDictionary.Add("AD", 29);
            columnDictionary.Add("AE", 30);
            columnDictionary.Add("AF", 31);
            columnDictionary.Add("AG", 32);
            columnDictionary.Add("AH", 33);
            columnDictionary.Add("AI", 34);
            columnDictionary.Add("AJ", 35);
            columnDictionary.Add("AK", 36);
            columnDictionary.Add("AL", 37);
            columnDictionary.Add("AM", 38);
            columnDictionary.Add("AN", 39);
            columnDictionary.Add("AO", 40);
            columnDictionary.Add("AP", 41);
            columnDictionary.Add("AQ", 42);
            columnDictionary.Add("AR", 43);
            columnDictionary.Add("AS", 44);
            columnDictionary.Add("AT", 45);
            columnDictionary.Add("AU", 46);
            columnDictionary.Add("AV", 47);
            columnDictionary.Add("AW", 48);
            columnDictionary.Add("AX", 49);
            columnDictionary.Add("AY", 50);
            columnDictionary.Add("AZ", 51);
            columnDictionary.Add("BA", 52);
            columnDictionary.Add("BB", 53);
            columnDictionary.Add("BC", 54);
            columnDictionary.Add("BD", 55);
            columnDictionary.Add("BE", 56);
            columnDictionary.Add("BF", 57);
            columnDictionary.Add("BG", 58);
            columnDictionary.Add("BH", 59);
            columnDictionary.Add("BI", 60);
            columnDictionary.Add("BJ", 61);
            columnDictionary.Add("BK", 62);
            columnDictionary.Add("BL", 63);
            columnDictionary.Add("BM", 64);
            columnDictionary.Add("BN", 65);
            columnDictionary.Add("BO", 66);
            columnDictionary.Add("BP", 67);
            columnDictionary.Add("BQ", 68);
            columnDictionary.Add("BR", 69);
            columnDictionary.Add("BS", 70);
            columnDictionary.Add("BT", 71);
            columnDictionary.Add("BU", 72);
            columnDictionary.Add("BV", 73);
            columnDictionary.Add("BW", 74);
            columnDictionary.Add("BX", 75);
            columnDictionary.Add("BY", 76);
            columnDictionary.Add("BZ", 77);
            columnDictionary.Add("CA", 78);
            columnDictionary.Add("CB", 79);
            columnDictionary.Add("CC", 80);
            columnDictionary.Add("CD", 81);
            columnDictionary.Add("CE", 82);
            columnDictionary.Add("CF", 83);
            columnDictionary.Add("CG", 84);
            columnDictionary.Add("CH", 85);
            columnDictionary.Add("CI", 86);
            columnDictionary.Add("CJ", 87);
            columnDictionary.Add("CK", 88);
            columnDictionary.Add("CL", 89);
            columnDictionary.Add("CM", 90);
            columnDictionary.Add("CN", 91);
            columnDictionary.Add("CO", 92);
            columnDictionary.Add("CP", 93);
            columnDictionary.Add("CQ", 94);
            columnDictionary.Add("CR", 95);
            columnDictionary.Add("CS", 96);
            columnDictionary.Add("CT", 97);
            columnDictionary.Add("CU", 98);
            columnDictionary.Add("CV", 99);
            columnDictionary.Add("CW", 100);
            columnDictionary.Add("CX", 101);
            columnDictionary.Add("CY", 102);
            columnDictionary.Add("CZ", 103);
            columnDictionary.Add("DA", 104);
            columnDictionary.Add("DB", 105);
            columnDictionary.Add("DC", 106);
            columnDictionary.Add("DD", 107);
            columnDictionary.Add("DE", 108);
            columnDictionary.Add("DF", 109);
            columnDictionary.Add("DG", 110);
            columnDictionary.Add("DH", 111);
            columnDictionary.Add("DI", 112);
            columnDictionary.Add("DJ", 113);
            columnDictionary.Add("DK", 114);
            columnDictionary.Add("DL", 115);
            columnDictionary.Add("DM", 116);
            columnDictionary.Add("DN", 117);
            columnDictionary.Add("DO", 118);
            columnDictionary.Add("DP", 119);
            columnDictionary.Add("DQ", 120);
            columnDictionary.Add("DR", 121);
            columnDictionary.Add("DS", 122);
            columnDictionary.Add("DT", 123);
            columnDictionary.Add("DU", 124);
            columnDictionary.Add("DV", 125);
            columnDictionary.Add("DW", 126);
            columnDictionary.Add("DX", 127);
            columnDictionary.Add("DY", 128);
            columnDictionary.Add("DZ", 129);
        }
