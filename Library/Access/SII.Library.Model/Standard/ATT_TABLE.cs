...
namespace Agro.Library.Model
{
    ...
    public class ATT_SUMMERY:EntityBase//<ATT_SUMMERY> 
    {
        #region Filds
        ...
        /// 累计
        /// </summary>
        public void Add(ATT_SUMMERY data)
        {
            if (data == null)
            {
                return;
