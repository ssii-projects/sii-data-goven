...
namespace Agro.Library.Model
{
    ...
    /// </summary>
    [Serializable]
    [DataTable("ZJQY", AliasName = "组级区域")]
    public class VEC_ZJQY
    {
        #region Propertys
        ...
        /// 组级行政区代码(M)
        /// </summary>
        [DataColumn("ZJQYDM", AliasName = "组级行政区代码")]
        public virtual string ZJQYDM { get; set; }

        /// <summary>
        /// 组级行政区名称(M)
        /// </summary>
        [DataColumn("ZJQYMC", AliasName = "组级行政区名称")]
        public virtual string ZJQYMC { get; set; }
