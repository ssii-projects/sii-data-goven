...
namespace Agro.Library.Model
{
    ...
    public class DLXX_DK : Entity<DLXX_DK>
	{
        ...
        /// 图形
        /// </summary>
        [DataColumn("Shape", GeometryType = GeometryType.Polygon)]
		...
		/// EDKZT
		/// </summary>
		[DataColumn(FieldType =eFieldType.eFieldTypeInteger)]
		public int ZT { get; set; } =(int)EDKZT.Youxiao;
		...
		[DataColumn(AliasName ="数据来源",FieldType =eFieldType.eFieldTypeInteger)]
